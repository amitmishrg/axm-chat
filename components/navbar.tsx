...
export const Navbar = async () => {
  return (
    <>
      <div className="bg-background absolute top-0 left-0 w-dvw py-2 px-3 justify-between flex gap-3 items-center z-30">
        <Link href={'/'}>
        ...
        <div className="flex space-x-2 items-center">
          <Button variant="outline">
            <Link href={'/details'}>Why should we use AI-SDK?</Link>
          </Button>
          <Button variant="outline">
